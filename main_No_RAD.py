...
def Extrema():
    ...
    with open(out_dir1 + 'extrema_press_lowestTemp_GTS_RH_MR_UV_Rate_TherGrad_HeatFlux_TOA_absBoomDiff_sol_02579_02692.dat','w') as output_file_Extrema:
                                                                                                    ...
                                                                                                    if l == k:
                                                                                                        ...
                                                                                                        for m in sun11:
                                                                                                            if m == l:
                                                                                                                ...
                                                                                                                '   '+str(abs_minUV_Temp[pos6]) + '   ' + str(EXTREMA_VMR_GTS[pos12])+ '   ' + str(EXTREMA_boom1[pos13])+ '   ' + str(EXTREMA_boom2[pos14]) + '\n')                        
