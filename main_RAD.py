...
init_path = os.path.dirname(os.path.abspath(__file__)) #Get the path where the actual file is located.

real_t = 'float64'
# Variables Declaration
# Path from where I am reading
in_dir = init_path + "/1_AWK/RAW_ALL/MD_RAW/"
# path where I will put the results
out_dir = init_path + "/1_AWK/CLEAN_ALL/MD_CLEAN/"
#NV path
in_dir2 = init_path + "/1_AWK/RAW_ALL/NV_RAW/"
# path where I will put the results
out_dir2 = init_path + "/1_AWK/CLEAN_ALL/NV_CLEAN/"

in_dir3 = init_path + "/1_AWK/RAW_ALL/ADR_RAW/"
# path where I will put the results
out_dir3 = init_path + "/1_AWK/CLEAN_ALL/ADR_CLEAN/"
                ...
                with open(in_dir3 + adr_file, 'r+') as textfile1, open(out_dir3 + w_file, 'w+') as output_file:
                    ...
                    for y in (textfile1):
                        ...
                        if len(y)<9:
                            ...
                            #Here we select the colums in which we are interested in
...
# Path from where I am reading
in_dir = init_path + "/1_AWK/CLEAN_ALL/MD_CLEAN/"
in_dir2 = init_path + "/1_AWK/CLEAN_ALL/NV_CLEAN/"
in_dirMD = init_path + "/1_AWK/CLEAN_ALL/MD_CLEAN/"
in_dirNV = init_path + "/1_AWK/CLEAN_ALL/NV_CLEAN/"

# path where I will put the results

out_dir1 = init_path + "/2_MEAN/Mean1/Out_Temp_B1_B2/"
out_dir2 = init_path + "/2_MEAN/Mean1/Out_Lowest_Temp/"
out_dir3 = init_path + "/2_MEAN/Mean1/Out_Means_GTS/"
out_dir4 = init_path + "/2_MEAN/Mean1/Out_Mean_Pressure/"
out_dir5 = init_path + "/2_MEAN/Mean1/Out_Mean_UV/"
out_dir6 = init_path + "/2_MEAN/Mean1/Out_Means/"

# path where I will put the results
out_dirMD = init_path + "/2_MEAN/Mean1/MD_CLEAN/"
out_dirNV = init_path + "/2_MEAN/Mean1/NV_CLEAN/"
...
out_dirMD = init_path + "/2_MEAN/Mean1/MD_CLEAN/"
out_dirNV = init_path + "/2_MEAN/Mean1/NV_CLEAN/"
# out_dirMD = init_path + "/2_MEAN/Mean5/MD_CLEAN/"
# out_dirNV = init_path + "/2_MEAN/Mean5/NV_CLEAN/"

out_dir1 = init_path + "/2_MEAN/Mean5/Out_Temp_B1_B2/"
out_dir2 = init_path + "/2_MEAN/Mean5/Out_lowest_Temp/"
out_dir3 = init_path + "/2_MEAN/Mean5/Out_Mean_GTS/"
out_dir4 = init_path + "/2_MEAN/Mean5/Out_mean_Pressure/"
out_dir5 = init_path + "/2_MEAN/Mean5/Out_mean_UV/"
out_dir6 = init_path + "/2_MEAN/Mean5/Out_mean_RH/"
out_dir7 = init_path + "/2_MEAN/Mean5/Out_mean_Tg_P/"
out_dir8 = init_path + "/2_MEAN/Mean5/Out_mean_P_Tg_Ta_rho/"
out_dir9 = init_path + "/2_MEAN/Mean5/Out_Means/"
...
# out_dirMD = init_path + "/2_MEAN/Mean6/MD_CLEAN/"
# out_dirNV = init_path + "/2_MEAN/Mean6/NV_CLEAN/"

out_dirMD = init_path + "/2_MEAN/Mean1/MD_CLEAN/"
out_dirNV = init_path + "/2_MEAN/Mean1/NV_CLEAN/"

out_dir1 = init_path + "/2_MEAN/Mean6/Out_Temp_B1_B2/"
out_dir2 = init_path + "/2_MEAN/Mean6/Out_lowest_Temp/"
out_dir3 = init_path + "/2_MEAN/Mean6/Out_mean_GTS/"
out_dir4 = init_path + "/2_MEAN/Mean6/Out_mean_Pressure/"
out_dir5 = init_path + "/2_MEAN/Mean6/Out_mean_UV/"
out_dir6 = init_path + "/2_MEAN/Mean6/Out_mean_RH/"

out_dir9 = init_path + "/2_MEAN/Mean6/Out_means/"
                    ...
                    for MD, NV in zip(input_fileMD, input_fileNV):
                        ...
                        if len(col) < 10 or len(colNV)<6:
                            ...
                            if (((current_sclk - prior_sclk) >= pause) or (current_sclk >= end_sclk) or (prior_hour != current_hour)):
                                ...
                                mean_sec = get_meanTime(time_1, time_2)# Mean time in seconds
                                mean_timeLMST = getLMST(mean_sec)# Mean in LMST format
                                block_hours.append(current_hour) 
                                new_init = True
                                mean_local_H = round(mean_local_H, 2)
                                mean_H_Temp = round(mean_H_Temp, 2)
                                mean_GTS = round(mean_GTS, 2)
                                ...
                                if mean_sec<300:
                                    mean_sec=mean_sec-2
                                    mean_timeLMST = getLMST(mean_sec)
...
in_dir = init_path + "/2_MEAN/Mean5/Out_Mean_GTS/"

out_dir1 = init_path + "/3_Splines/Derivative/"
...
out_dir2 = init_path + "/3_Splines/GTSspli/"
...
in_dir = init_path + "/2_MEAN/Mean5/Out_mean_Pressure/"  
out_dir1 = init_path + "//3_Splines/Pspline/"
...
out_dir1 = init_path + "/4_RH/RHumidity/"
            ...
            if str(file).endswith('.dat'):
                ...
                if os.stat(in_dir + md_file).st_size != 0:
                    ...
                    with open(out_dir1 + 'first_RH_first_Instants_sol_' + sun+ '.dat','r') as input_file, open(out_dir1 + 'RH_first_Instants_sol_' + sun+ '.dat','w') as output_file:
                        j = 0
                        block_hours = False #Varaible in charge of knowing if the mean for a centarin hour is done (true) or not (false).
                        new_init = True 
                        file=input_file.name
                        ...
                        for i in input_file:
                            ...
                            if len(col) < 4:
                                ...
                                if current_hour in block_hours:
                                    ...
                                    #IInitialize the time to start a new hour
                                    prior_sclk = current_sclk
                                    prior_hour = current_hour
                                    end_sclk = current_sclk + block_secs
...
in_dir1 = init_path + "/4_RH/RHumidity/"
in_dir2 = init_path + "/3_Splines/Pspline/"
in_dir3 = init_path + "/3_Splines/GTSspli/"
out_dir1 = init_path + "/4_RH/RHSurface5/"
...
in_dir1 = init_path + "/2_MEAN/Mean6/Out_means/"
out_dir1 = init_path + "/4_RH/RHSurface6/"
...
in_dir = init_path + "/1_AWK/CLEAN_ALL/NV_CLEAN/"

out_dir1 = init_path + "/5_UV/"
...
in_dir = init_path + "/3_Splines/Derivative/"
out_dir1 = init_path + "/6_HEA_COO/Derivative_GTS/"
...
in_dir = init_path + "/6_HEA_COO/Derivative_GTS/"
out_dir1 = init_path + "/6_HEA_COO/splineGTS/"
...
in_dir = init_path + "/6_HEA_COO/splineGTS/"
out_dir1 = init_path + "/6_HEA_COO/localExtrema/"
...
in_dir = init_path + "/2_MEAN/Mean5/Out_Means/"

out_dir1 = init_path + "/7_AirGround_Tdiff/"
...
in_dir = init_path + "/1_AWK/CLEAN_ALL/MD_CLEAN/"
out_dir = init_path + "/9_VMR_GTS/VMR/"
...
in_dir = init_path + "/1_AWK/CLEAN_ALL/MD_CLEAN/"
in_dir2 = init_path + "/9_VMR_GTS/VMR/"

out_dir = init_path + "/9_VMR_GTS/VMR_GTS_P_MAX/"
...
# path where I will put the results
in_dir = init_path + "/1_AWK/CLEAN_ALL/MD_CLEAN/"
out_dir = init_path + "/10_ATS/Read_Global/"
...
in_dir = init_path + "/10_ATS/Read_Global/"
out_dir = init_path + "/10_ATS/ATS_Boom1_Calculations/"
#NV path
# path where I will put the results
...
in_dir = init_path + "/10_ATS/Read_Global/"
out_dir = init_path + "/10_ATS/ATS_Boom2_Calculations/"
...
in_dir = init_path + "/10_ATS/ATS_Boom1_Calculations/"
out_dir = init_path + "/10_ATS/ATS_Boom1_means/"
...
in_dir = init_path + "/10_ATS/ATS_Boom2_Calculations/"
out_dir = init_path + "/10_ATS/ATS_Boom2_means/"
...
in_dir = init_path + "/10_ATS/ATS_Boom1_means/"
in_dir2 = init_path + "/10_ATS/Read_Global/"

out_dir = init_path + "/10_ATS/ATS_Boom1_Global/"
...
in_dir = init_path + "/10_ATS/ATS_Boom2_means/"
in_dir2 = init_path + "/10_ATS/Read_Global/"

out_dir = init_path + "/10_ATS/ATS_Boom2_Global/"
...
print(st)
    ...
    #***************************************************************** Pressure Spline:
in_file_path1 = init_path + "/3_Splines/Pspline/"


 # ***************************************************************** lowest Air Temperature:
    ####################### nominal acquisitions:
in_file_path8 = init_path + "/2_MEAN/Mean5/Out_lowest_Temp/"

    ####################### nominal and extended acquisitions:
in_file_path2 = init_path + "/2_MEAN/Mean1/Out_Lowest_Temp/"

############### means GTS, sigma GTS, sigma RHSurf:
in_file_path3 = init_path + "/4_RH/RHSurface6/"

# ***************************************************************** RH air at 1.5m:
in_file_path4 = init_path + "/4_RH/RHSurface5/"

# ***************************************************************** Global, diffuse and direct irradiance:
in_file_path5 = init_path + "/5_UV/"

# ***************************************************************** Derivative Spline GTS
in_file_path6 = init_path + "/6_HEA_COO/splineGTS/"

# ***************************************************************** Difference AirTemp, GTS
in_file_path7 = init_path + "/7_AirGround_Tdiff/"

# ***************************************************************** u*rho*(Tg-Ta)
in_file_path9 = init_path + "/2_MEAN/Mean5/Out_mean_P_Tg_Ta_rho/"


# ***************************************************************** ENV & MOD from FMT V.6 (RDR_03.07.2015) para temperatura booms y UV temp
in_file_path10 = init_path + "/1_AWK/CLEAN_ALL/MD_CLEAN/"
in_file_path11 = init_path + "/1_AWK/CLEAN_ALL/NV_CLEAN/"
    
    
# ***************************************************************** ADR from FMT V.7 (RDR_18.02.2016) topography files
sun_topo_file_path = init_path + "/1_AWK/CLEAN_ALL/ADR_CLEAN/"


in_file_path12 = init_path + "/Other_Files/"
# in_file_path12 = "/data/PDS_Python/Code_Python/Other_files/" # IF THE PATH ABOVE NOT WORKING USE THIS ONE.

in_file_path13 = init_path + "/TOA/"

in_file_path14 = init_path + "/9_VMR_GTS/VMR_GTS_P_MAX/"

in_file_path15 = init_path + "/10_ATS/ATS_Boom1_Global/"

in_file_path16 = init_path + "/10_ATS/ATS_Boom2_Global/"
...
"[190]AVG_B [191]LMST_MAX_B [192]MAX_B [193]LMST_MIN_B [194]MIN_B [195]AVG_E [196]LMST_MAX_E [197]MAX_E [198]LMST_MIN_E [199]MIN_E\n"
